"""
==========
V2_MDCR_PRVDR_IDTF_ATSTTN IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_ATSTTN

Table Type: VIEW
Columns: 14
Source Pattern: %mdcr_prvdr%
Table Comment: THE IDTF - ATTESTATION CHILD RECORD IS USED TO COLLECT INFORMATION GATHERED FROM ATTACHMENT 2 WHEN IDTF HAS BEEN SELECTED AS THE SUPPLIER TYPE ON CMS FORM 855B
...
Usage:
    ...
    exporter = V2MdcrPrvdrIdtfAtsttnExporter()
...
class V2MdcrPrvdrIdtfAtsttnExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_IDTF_ATSTTN data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_ATSTTN (VIEW)
    Columns: 14
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_idtf_atsttn_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_IDTF_ATSTTN export.
        ...
        return """SELECT
                ...
                PRVDR_IDTF_STD_CD, -- TEXT(1) | NOT NULL | DATE THAT THE IDTF STARTED USING THE CPT-4 OR HCPCS EQUIPMENT
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_ATSTTN"""
