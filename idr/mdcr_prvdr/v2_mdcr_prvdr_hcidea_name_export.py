"""
==========
V2_MDCR_PRVDR_HCIDEA_NAME IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_NAME

Table Type: VIEW
Columns: 11
Source Pattern: %mdcr_prvdr%
Table Comment: THIS ENTITY STORES THE PRESCRIBERS NAME INFORMATION OBTAINED FROM VARIOUS SOURCES BY THE NCPDP COUNCIL FOR HCIDEA (HEALTH CARE IDENTIFIER DRUG ENFORCEMENT AGENCY) DATABASE FILE STANDARD.  NOTE: THIS TABLE IS NO LONGER BEING UPDATED BY THE SOURCE.
...
Usage:
    ...
    exporter = V2MdcrPrvdrHcideaNameExporter()
...
class V2MdcrPrvdrHcideaNameExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_HCIDEA_NAME data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_NAME (VIEW)
    Columns: 11
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_hcidea_name_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_HCIDEA_NAME export.
        ...
        return """SELECT
                ...
                PRVDR_HCIDEA_1ST_NAME, -- TEXT(250) | NOT NULL | FIRST NAME OF PROVIDER
                PRVDR_HCIDEA_CNFDNC_TIER_CD, -- NUMBER(38) | NOT NULL | THE CONFIDENCE TIER ASSOCIATED WITH THE FULL NAME VALUE. VALID VALUES: 1, 2, 3, 99
                PRVDR_HCIDEA_CORP_CNT, -- NUMBER(38) | NOT NULL | THE TOTAL COUNT OF DATA SOURCES THAT SUPPLIED THE FULL NAME VALUE.
                PRVDR_HCIDEA_LAST_NAME, -- TEXT(250) | NOT NULL | LAST NAME OF PROVIDER
                PRVDR_HCIDEA_MDL_NAME, -- TEXT(250) | NULL | MIDDLE NAME OF PROVIDER
                ...
                PRVDR_HCIDEA_SFX_NAME, -- TEXT(50) | NULL | PROVIDER NAME SUFFIX (JR, II, SR, III, 3RD, ETC)
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_NAME"""
