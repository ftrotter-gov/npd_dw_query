"""
==========
V2_MDCR_PRVDR_CRDNTL_AUDT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_CRDNTL_AUDT

Table Type: VIEW
Columns: 11
Source Pattern: %mdcr_prvdr%
Table Comment: AN AUDIT OF THE PROVIDER CREDENTIAL INFORMATION
...
Usage:
    ...
    exporter = V2MdcrPrvdrCrdntlAudtExporter()
...
class V2MdcrPrvdrCrdntlAudtExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_CRDNTL_AUDT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_CRDNTL_AUDT (VIEW)
    Columns: 11
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_crdntl_audt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_CRDNTL_AUDT export.
        ...
        return """SELECT
                ...
                PRVDR_CRDNTL_CD, -- TEXT(3) | NOT NULL | CREDENTIALS
                ...
                PRVDR_CRDNTL_AUDT_CREAT_DT, -- DATE | NULL | DATE DATA WAS CREATED IN SOURCE
                PRVDR_CRDNTL_AUDT_UPDT_DT -- DATE | NULL | DATE DATA WAS CORRECTED IN SOURCE
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_CRDNTL_AUDT"""
