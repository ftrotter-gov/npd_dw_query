"""
==========
V2_MDCR_PRVDR_LCNS_AUDT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_LCNS_AUDT

Table Type: VIEW
Columns: 12
Source Pattern: %mdcr_prvdr%
Table Comment: AN AUDIT OF THE PROVIDER LICENSE INFORMATION
...
Usage:
    ...
    exporter = V2MdcrPrvdrLcnsAudtExporter()
...
class V2MdcrPrvdrLcnsAudtExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_LCNS_AUDT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_LCNS_AUDT (VIEW)
    Columns: 12
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_lcns_audt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_LCNS_AUDT export.
        ...
        return """SELECT
                ...
                PRVDR_LCNS_NUM, -- TEXT(12) | NOT NULL | STATE LICENSE NUMBER
                PRVDR_LCNS_STATE_CD, -- TEXT(2) | NOT NULL | STATE LICENSE STATE
                ...
                PRVDR_LCNS_AUDT_CREAT_DT, -- DATE | NULL | DATE DATA WAS CREATED IN SOURCE
                PRVDR_LCNS_AUDT_UPDT_DT -- DATE | NULL | DATE DATA WAS CORRECTED IN SOURCE
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_LCNS_AUDT"""
