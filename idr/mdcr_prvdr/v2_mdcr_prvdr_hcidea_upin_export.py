"""
==========
V2_MDCR_PRVDR_HCIDEA_UPIN IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_UPIN

Table Type: VIEW
Columns: 8
Source Pattern: %mdcr_prvdr%
Table Comment: A LINK BETWEEN THE UNIQUE PHYSICIAN IDENTIFICATION NUMBER (UPIN) TO THE HCIDEA PROVIDER ID. ALTHOUGH THE ASSIGNMENT OF UPINS WAS DISCONTINUED BY THE CENTERS FOR MEDICARE AND MEDICAID SEVICES (CMS) IN JUNE 2007 AND REPLACED BY THE NATIONAL PROVIDER IDENTIFIER (NPI), THIS TABLE PROVIDES THE UPIN ASSOCIATION FOR HISTORICAL TRACKING PURPOSES.  HCIDEA IS THE HEALTH CARE IDENTIFIER DRUG ENFORCEMENT AGENCY DATABASE FILE STANDARD GOVERNED BY NCPDP.  NOTE: THIS TABLE IS NO LONGER BEING UPDATED BY THE SOURCE.
...
Usage:
    ...
    exporter = V2MdcrPrvdrHcideaUpinExporter()
...
class V2MdcrPrvdrHcideaUpinExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_HCIDEA_UPIN data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_UPIN (VIEW)
    Columns: 8
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_hcidea_upin_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_HCIDEA_UPIN export.
        ...
        return """SELECT
                ...
                PRVDR_HCIDEA_UPIN_NUM, -- TEXT(20) | NOT NULL | CMS-ASSIGNED UPIN OF THE PROVIDER
                PRVDR_HCIDEA_CNFDNC_TIER_CD, -- NUMBER(38) | NOT NULL | THE CONFIDENCE TIER ASSOCIATED WITH THE UPIN VALUE. VALID VALUES: 1, 2, 3, 99
                PRVDR_HCIDEA_CORP_CNT, -- NUMBER(38) | NOT NULL | THE TOTAL COUNT OF DATA SOURCES THAT SUPPLIED THE UPIN VALUE
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_UPIN"""
