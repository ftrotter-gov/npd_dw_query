"""
==========
V2_MDCR_PRVDR_HCIDEA_GNDR IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_GNDR

Table Type: VIEW
Columns: 8
Source Pattern: %mdcr_prvdr%
Table Comment: THIS ENTITY STORES THE PRESCRIBERS SEX INFORMATION OBTAINED FROM VARIOUS SOURCES BY THE NCPDP COUNCIL FOR THE HCIDEA (HEALTH CARE IDENTIFIER DRUG ENFORCEMENT AGENCY ) DATABASE FILE STANDARD.  NOTE: THIS TABLE IS NO LONGER BEING UPDATED BY THE SOURCE.
...
Usage:
    ...
    exporter = V2MdcrPrvdrHcideaGndrExporter()
...
class V2MdcrPrvdrHcideaGndrExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_HCIDEA_GNDR data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_GNDR (VIEW)
    Columns: 8
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_hcidea_gndr_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_HCIDEA_GNDR export.
        ...
        return """SELECT
                ...
                PRVDR_HCIDEA_CNFDNC_TIER_CD, -- NUMBER(38) | NOT NULL | THE CONFIDENCE TIER ASSOCIATED WITH THE SEX VALUE. VAID VALUES 1,2,3,99
                PRVDR_HCIDEA_CORP_CNT, -- NUMBER(38) | NOT NULL | THE TOTAL COUNT OF DATA SOURCES THAT SUPPLIED THE SEX VALUE.
                PRVDR_HCIDEA_GNDR_CD, -- TEXT(1) | NOT NULL | A CODE DESCRIBING THE SEX OF THE PROVIDER OBTAINED FROM VARIOUS SOURCES. VALID VALUES: M-MALE, F-FEMALE
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_GNDR"""
