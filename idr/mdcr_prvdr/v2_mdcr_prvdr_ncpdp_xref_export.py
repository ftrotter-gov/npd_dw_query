"""
==========
V2_MDCR_PRVDR_NCPDP_XREF IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_NCPDP_XREF

Table Type: VIEW
Columns: 5
Source Pattern: %mdcr_prvdr%
Table Comment: A CROSS REFERENCE OF A NATIONAL COUNCIL FOR PRESCRIPTION DRUG PROGRAMS (NCPDP) NUMBER TO A NATIONAL PROVIDER IDENTIFIER (NPI) INDICATING ACTIVE/INACTIVE STATUS FOR THE COMBINATION.
...
Usage:
    ...
    exporter = V2MdcrPrvdrNcpdpXrefExporter()
...
class V2MdcrPrvdrNcpdpXrefExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_NCPDP_XREF data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_NCPDP_XREF (VIEW)
    Columns: 5
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_ncpdp_xref_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_NCPDP_XREF export.
        ...
        return """SELECT
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_NCPDP_XREF"""
