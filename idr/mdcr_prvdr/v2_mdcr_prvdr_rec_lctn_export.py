"""
==========
V2_MDCR_PRVDR_REC_LCTN IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_REC_LCTN

Table Type: VIEW
Columns: 16
Source Pattern: %mdcr_prvdr%
Table Comment: THE LOCATION OF PATIENTS’ MEDICAL RECORDS CHILD RECORD IS CREATED TO COLLECT INFORMATION OF THE STORAGE LOCATION IF DIFFERENT FROM THE PRACTICE LOCATION.
...
Usage:
    ...
    exporter = V2MdcrPrvdrRecLctnExporter()
...
class V2MdcrPrvdrRecLctnExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_REC_LCTN data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_REC_LCTN (VIEW)
    Columns: 16
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_rec_lctn_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_REC_LCTN export.
        ...
        return """SELECT
                ...
                PRVDR_REC_LCTN_INVLD_STATE_CD, -- TEXT(2) | NOT NULL | UNIQUE VALUE THAT IDENTIFIES A STATE.
                ...
                PRVDR_REC_LCTN_LINE_1_ADR, -- TEXT(55) | NOT NULL | LINE1 STREET ADDRESS LOCATION.
                PRVDR_REC_LCTN_LINE_2_ADR, -- TEXT(55) | NOT NULL | LINE2 STREET ADDRESS LOCATION.
                PRVDR_REC_LCTN_NAME, -- TEXT(35) | NOT NULL | STORES THE LOCATION NAME.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_REC_LCTN"""
