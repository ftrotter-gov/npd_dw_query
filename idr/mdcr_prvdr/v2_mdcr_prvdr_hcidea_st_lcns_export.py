"""
==========
V2_MDCR_PRVDR_HCIDEA_ST_LCNS IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_ST_LCNS

Table Type: VIEW
Columns: 11
Source Pattern: %mdcr_prvdr%
Table Comment: A STATE LICENSE(S) HELD BY THE PRESCRIBER AS SOURCED FROM THE NCPDP HCIDEA (HEALTH CARE IDENTIFIER DRUG ENFORCEMENT AGENCY) DATA. THE PRESCRIBER CAN BE LICENSED IN MULTIPLE STATES SO EACH LICENSE NUMBER IS ALSO IDENTIFIED BY THE ISSUING STATE.  NOTE: THIS TABLE IS NO LONGER BEING UPDATED BY THE SOURCE.
...
Usage:
    ...
    exporter = V2MdcrPrvdrHcideaStLcnsExporter()
...
class V2MdcrPrvdrHcideaStLcnsExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_HCIDEA_ST_LCNS data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_ST_LCNS (VIEW)
    Columns: 11
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_hcidea_st_lcns_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_HCIDEA_ST_LCNS export.
        ...
        return """SELECT
                ...
                PRVDR_HCIDEA_LCNS_NUM, -- TEXT(50) | NOT NULL | STATE LICENSE NUMBER OF THE PROVIDER
                PRVDR_HCIDEA_LCNS_STATE_CD, -- TEXT(2) | NOT NULL | ISSUING STATE OF THE LICENSE NUMBER
                PRVDR_HCIDEA_CNFDNC_TIER_CD, -- NUMBER(38) | NOT NULL | THE CONFIDENCE TIER ASSOCIATED WITH THE STATE LICENSE VALUE. VALID VALUES: 1, 2, 3, 99
                PRVDR_HCIDEA_CORP_CNT, -- NUMBER(38) | NOT NULL | THE TOTAL COUNT OF DATA SOURCES THAT SUPPLIED THE STATE LICENSE VALUE.
                PRVDR_HCIDEA_LCNS_EXPRTN_DT, -- DATE | NULL | EXPIRATION DATE OF THE LICENSE.
                PRVDR_HCIDEA_LCNS_ISS_DT, -- DATE | NULL | EFFECTIVE DATE OF THE LICENSE.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_ST_LCNS"""
