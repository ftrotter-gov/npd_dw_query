"""
==========
V2_MDCR_PRVDR_HCIDEA_DGR IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_DGR

Table Type: VIEW
Columns: 8
Source Pattern: %mdcr_prvdr%
Table Comment: A PRESCRIBERS EDUCATIONAL QUALIFICATIONS (DEGREES) INFORMATION OBTAINED FROM VARIOUS SOURCES AND CONSOLIDATED IN THE HCIDEA (HEALTH CARE IDENTIFIER DRUG ENFORCEMENT AGENCY)  DATA.  NOTE: THIS TABLE IS NO LONGER BEING UPDATED BY THE SOURCE.
...
Usage:
    ...
    exporter = V2MdcrPrvdrHcideaDgrExporter()
...
class V2MdcrPrvdrHcideaDgrExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_HCIDEA_DGR data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_DGR (VIEW)
    Columns: 8
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_hcidea_dgr_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_HCIDEA_DGR export.
        
        Includes all 8 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                PRVDR_HCIDEA_DGR_ACRNM_NAME, -- TEXT(15) | NOT NULL | AN ACRONYM OF THE EDUCATIONAL DEGREE EARNED BY THE PRESCRIBER
                ...
                PRVDR_HCIDEA_CNFDNC_TIER_CD, -- NUMBER(38) | NOT NULL | THE CONFIDENCE TIER ASSOCIATED WITH THE DEGREE VALUE. VALID VALUES: 1, 2, 3, 99
                PRVDR_HCIDEA_CORP_CNT, -- NUMBER(38) | NOT NULL | THE TOTAL COUNT OF DATA SOURCES THAT SUPPLIED THE DEGREE VALUE.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_HCIDEA_DGR"""
