"""
==========
V2_MDCR_PRVDR_INTRPTNG_PHYSN IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_INTRPTNG_PHYSN

Table Type: VIEW
Columns: 14
Source Pattern: %mdcr_prvdr%
Table Comment: THE IDTF INTERPRETING PHYSICIAN CHILD RECORD CONTAINS INFORMATION GATHERED FROM ATTACHMENT 2 WHEN IDTF HAS BEEN SELECTED AS THE SUPPLIER TYPE ON CMS FORM 855B
...
Usage:
    ...
    exporter = V2MdcrPrvdrIntrptngPhysnExporter()
...
class V2MdcrPrvdrIntrptngPhysnExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_INTRPTNG_PHYSN data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_INTRPTNG_PHYSN (VIEW)
    Columns: 14
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_intrptng_physn_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_INTRPTNG_PHYSN export.
        ...
        return """SELECT
                ...
                PRVDR_IDTF_PHYSN_1ST_NAME, -- TEXT(25) | NOT NULL | FIRST NAME OF INTERPRETING PHYSICIAN
                PRVDR_IDTF_PHYSN_LAST_NAME, -- TEXT(35) | NOT NULL | LAST NAME OF INTERPRETING PHYSICIAN
                PRVDR_IDTF_PHYSN_MDL_NAME, -- TEXT(25) | NULL | MIDDLE NAME OF INTERPRETING PHYSICIAN
                PRVDR_IDTF_PHYSN_ASCT_DT, -- DATE | NULL | DATE THE INTERPRETING PHYSICIAN WAS ASSOCIATED WITH THIS INDEPENDENT DIAGNOSTIC TESTING FACILITY (IDTF).
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_INTRPTNG_PHYSN"""
