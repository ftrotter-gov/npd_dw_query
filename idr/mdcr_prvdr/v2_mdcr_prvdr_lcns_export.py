"""
==========
V2_MDCR_PRVDR_LCNS IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_LCNS

Table Type: VIEW
Columns: 10
Source Pattern: %mdcr_prvdr%
Table Comment: THE STATE LICENSE CHILD RECORD IS USED TO COLLECT STATE LICENSE INFORMATION.
...
Usage:
    ...
    exporter = V2MdcrPrvdrLcnsExporter()
...
class V2MdcrPrvdrLcnsExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_LCNS data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_LCNS (VIEW)
    Columns: 10
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_lcns_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_LCNS export.
        
        Includes all 10 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                PRVDR_LCNS_NUM, -- TEXT(12) | NOT NULL | LICENSE NUMBER COMBINES WITH STATE CODE TO PROVIDE UNIQUE IDENTIFYING INFORMATION.
                PRVDR_LCNS_STATE_CD, -- TEXT(2) | NOT NULL | UNIQUE VALUE THAT IDENTIFIES A STATE.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_LCNS"""
