"""
==========
V2_MDCR_PRVDR_IDTF_EQUIP_AUDT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_EQUIP_AUDT

Table Type: VIEW
Columns: 15
Source Pattern: %mdcr_prvdr%
Table Comment: AN AUDIT OF THE PROVIDER INDEPENDENT DIAGNOSTIC TESTING FACILITY EQUIPMENT INFORMATION
...
Usage:
    ...
    exporter = V2MdcrPrvdrIdtfEquipAudtExporter()
...
class V2MdcrPrvdrIdtfEquipAudtExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_IDTF_EQUIP_AUDT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_EQUIP_AUDT (VIEW)
    Columns: 15
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_idtf_equip_audt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_IDTF_EQUIP_AUDT export.
        ...
        return """SELECT
                ...
                PRVDR_IDTF_EQUIP_MODEL_NUM, -- TEXT(20) | NOT NULL | MODEL NUMBER OF THE REPORTED EQUIPMENT.
                ...
                PRVDR_IDTF_EQUIP_AUDT_CREAT_DT, -- DATE | NULL | DATE DATA WAS CREATED IN SOURCE
                PRVDR_IDTF_EQUIP_AUDT_UPDT_DT, -- DATE | NULL | DATE DATA WAS CORRECTED IN SOURCE
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_EQUIP_AUDT"""
