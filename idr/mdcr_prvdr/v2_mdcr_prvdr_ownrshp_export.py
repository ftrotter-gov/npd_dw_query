"""
==========
V2_MDCR_PRVDR_OWNRSHP IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_OWNRSHP
...
Usage:
    ...
    exporter = V2MdcrPrvdrOwnrshpExporter()
...
class V2MdcrPrvdrOwnrshpExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_OWNRSHP data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_OWNRSHP (VIEW)
    Columns: 28
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_ownrshp_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_OWNRSHP export.
        ...
        return """SELECT
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_OWNRSHP"""
