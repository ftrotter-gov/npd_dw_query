"""
==========
V2_MDCR_PRVDR_SRVC_CD IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_SRVC_CD

Table Type: VIEW
Columns: 7
Source Pattern: %mdcr_prvdr%
Table Comment: IDENTIFIES HOW CERTAIN SERVICES ARE PROVIDED.
...
Usage:
    ...
    exporter = V2MdcrPrvdrSrvcCdExporter()
...
class V2MdcrPrvdrSrvcCdExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_SRVC_CD data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_SRVC_CD (VIEW)
    Columns: 7
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_srvc_cd_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_SRVC_CD export.
        
        Includes all 7 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                PRVDR_SRVC_CD, -- TEXT(20) | NOT NULL | A CODE TO INDICATE HOW CERTAIN SERVICES ARE PROVIDED.
                PRVDR_SRVC_DESC, -- TEXT(100) | NOT NULL | THE DESCRIPTION OF THE CODE IDENTIFYING HOW CERTAIN SERVICES ARE PROVIDED.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_SRVC_CD"""
