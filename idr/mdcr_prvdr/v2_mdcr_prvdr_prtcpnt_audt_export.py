"""
==========
V2_MDCR_PRVDR_PRTCPNT_AUDT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_PRTCPNT_AUDT

Table Type: VIEW
Columns: 14
Source Pattern: %mdcr_prvdr%
Table Comment: AN AUDIT OF THE PROVIDER PARTICIPANT STATUS INFORMATION.
...
Usage:
    ...
    exporter = V2MdcrPrvdrPrtcpntAudtExporter()
...
class V2MdcrPrvdrPrtcpntAudtExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_PRTCPNT_AUDT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_PRTCPNT_AUDT (VIEW)
    Columns: 14
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_prtcpnt_audt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_PRTCPNT_AUDT export.
        ...
        return """SELECT
                ...
                PRVDR_PRTCPNT_AUDT_BGN_DT, -- DATE | NULL | IDENTIFIES THE EFFECTIVE DATE OF THE PARTICIPANT STATUS.
                PRVDR_PRTCPNT_AUDT_END_DT, -- DATE | NOT NULL | IDENTIFIES THE TERMINATION DATE OF THE PARTICIPANT STATUS.
                PRVDR_ENRLMT_ID, -- TEXT(15) | NOT NULL | PECOS SYSTEM GENERATED ENROLLMENT IDENTIFIER.
                PRVDR_PRTCPNT_AUDT_IND_CD, -- TEXT(1) | NOT NULL | INDENTIFIES PROVIDERS AS PARTICIPANTS OR NON-PARTICIPANTS.
                ...
                PRVDR_PRTCPNT_AUDT_CREAT_DT, -- DATE | NULL | DATE DATA WAS CREATED IN SOURCE
                PRVDR_PRTCPNT_AUDT_UPDT_DT -- DATE | NULL | DATE DATA WAS CORRECTED IN SOURCE
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_PRTCPNT_AUDT"""
