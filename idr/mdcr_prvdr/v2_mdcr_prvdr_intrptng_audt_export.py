"""
==========
V2_MDCR_PRVDR_INTRPTNG_AUDT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_INTRPTNG_AUDT
...
Usage:
    ...
    exporter = V2MdcrPrvdrIntrptngAudtExporter()
...
class V2MdcrPrvdrIntrptngAudtExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_INTRPTNG_AUDT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_INTRPTNG_AUDT (VIEW)
    Columns: 16
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_intrptng_audt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_INTRPTNG_AUDT export.
        ...
        return """SELECT
                ...
                PRVDR_IDTF_PHYSN_MDL_NAME, -- TEXT(25) | NULL | PROVIDER INDEPENDENT DIAGNOSTIC TESTING FACILITY PHYSICIAN MIDDLE NAME
                ...
                PRVDR_INTRPTNG_AUDT_CREAT_DT, -- DATE | NULL | DATE DATA WAS CREATED IN SOURCE
                PRVDR_INTRPTNG_AUDT_UPDT_DT -- DATE | NULL | DATE DATA WAS CORRECTED IN SOURCE
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_INTRPTNG_AUDT"""
