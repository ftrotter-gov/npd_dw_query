"""
==========
V2_MDCR_PRVDR_IDTF_HCPCS IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_HCPCS

Table Type: VIEW
Columns: 12
Source Pattern: %mdcr_prvdr%
Table Comment: THE IDTF CPT-4 AND HCPCS CODES CHILD RECORD CONTAINS INFORMATION GATHERED FROM ATTACHMENT 2 WHEN IDTF HAS BEEN SELECTED AS THE SUPPLIER TYPE ON CMS FORM 855B
...
Usage:
    ...
    exporter = V2MdcrPrvdrIdtfHcpcsExporter()
...
class V2MdcrPrvdrIdtfHcpcsExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_IDTF_HCPCS data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_HCPCS (VIEW)
    Columns: 12
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_idtf_hcpcs_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_IDTF_HCPCS export.
        
        Includes all 12 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                HCPCS_CD, -- TEXT(5) | NOT NULL | A CODE FROM CMSS COMMON PROCEDURAL CODING SYSTEM (HCPCS) IS A COLLECTION OF CODES THAT REPRESENT PROCEDURES, SUPPLIES, PRODUCTS AND SERVICES WHICH MAY BE PROVIDED TO MEDICARE AND MEDICARE BENEFICIARIES AND TO INDIVIDUALS ENROLLED IN PRIVATE HEALTH INSURANCE PROGRAMS. THE CODE ARE DIVIDED INTO THREE LEVELS, OR GROUPS.
                ...
                CLNDR_HCPCS_YR_NUM, -- NUMBER(4) | NOT NULL | THE CALENDAR YEAR NUMBER.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_IDTF_HCPCS"""
