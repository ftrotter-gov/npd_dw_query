"""
==========
V2_MDCR_PRVDR_SBUNIT_AUDT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_SBUNIT_AUDT

Table Type: VIEW
Columns: 14
Source Pattern: %mdcr_prvdr%
Table Comment: AN AUDIT OF THE PROVIDER SUBUNIT INFORMATION
...
Usage:
    ...
    exporter = V2MdcrPrvdrSbunitAudtExporter()
...
class V2MdcrPrvdrSbunitAudtExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_SBUNIT_AUDT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_SBUNIT_AUDT (VIEW)
    Columns: 14
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_sbunit_audt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_SBUNIT_AUDT export.
        ...
        return """SELECT
                ...
                PRVDR_MDCR_ID, -- TEXT(15) | NOT NULL | MEDICARE ID NUMBER OF BUYER/SELLER/OLD/NEW
                ...
                PRVDR_SBUNIT_DEPT_NAME, -- TEXT(70) | NULL | DEPARTMENT NAME
                ...
                PRVDR_SBUNIT_AUDT_CREAT_DT, -- DATE | NULL | DATE DATA WAS CREATED IN SOURCE
                PRVDR_SBUNIT_AUDT_UPDT_DT, -- DATE | NULL | DATE DATA WAS CORRECTED IN SOURCE
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_SBUNIT_AUDT"""
