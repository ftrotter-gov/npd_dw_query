"""
==========
V2_MDCR_PRVDR_ACRDTN_TYPE_CD IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_ACRDTN_TYPE_CD
...
Usage:
    ...
    exporter = V2MdcrPrvdrAcrdtnTypeCdExporter()
...
class V2MdcrPrvdrAcrdtnTypeCdExporter(IDROutputter):
    """
    Exports V2_MDCR_PRVDR_ACRDTN_TYPE_CD data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_ACRDTN_TYPE_CD (VIEW)
    Columns: 5
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcr_prvdr_acrdtn_type_cd_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCR_PRVDR_ACRDTN_TYPE_CD export.
        
        Includes all 5 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                PRVDR_ACRDTN_TYPE_CD, -- TEXT(1) | NOT NULL | THIS CODE INDICATES THE ORGANIZATION THAT IS RESPONSIBLE FOR THE ACCREDITATION OF THE PROVIDER.
                ...
                PRVDR_ACRDTN_TYPE_DESC, -- TEXT(100) | NULL | DESCRIPTION OF A CODE FOR PROVIDER ACCREDITATION TYPE
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_MDCR_PRVDR_ACRDTN_TYPE_CD"""
