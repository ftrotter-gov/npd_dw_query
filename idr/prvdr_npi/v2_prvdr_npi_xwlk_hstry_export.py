"""
==========
V2_PRVDR_NPI_XWLK_HSTRY IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_NPI_XWLK_HSTRY

Table Type: VIEW
Columns: 14
Source Pattern: %prvdr_npi%
Table Comment: THIS VIEW REPRESENTS A HISTORICAL SNAPSHOT OF A CROSSWALK OF A NATIONAL PROVIDER IDENTIFIER (NPI) TO THEIR CORRESPONDING HEALTH CARE PROVIDERS OTHER IDENTIFICATION NUMBER RECEIVED FROM THE NATIONAL PLAN AND PROVIDER ENUMERATION SYSTEM (NPPES).
...
Usage:
    ...
    exporter = V2PrvdrNpiXwlkHstryExporter()
...
class V2PrvdrNpiXwlkHstryExporter(IDROutputter):
    """
    Exports V2_PRVDR_NPI_XWLK_HSTRY data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_NPI_XWLK_HSTRY (VIEW)
    Columns: 14
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_npi_xwlk_hstry_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_NPI_XWLK_HSTRY export.
        ...
        return """SELECT
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_NPI_XWLK_HSTRY"""
