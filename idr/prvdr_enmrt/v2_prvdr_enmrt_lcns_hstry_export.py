"""
==========
V2_PRVDR_ENMRT_LCNS_HSTRY IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_LCNS_HSTRY
...
Usage:
    ...
    exporter = V2PrvdrEnmrtLcnsHstryExporter()
...
class V2PrvdrEnmrtLcnsHstryExporter(IDROutputter):
    """
    Exports V2_PRVDR_ENMRT_LCNS_HSTRY data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_LCNS_HSTRY (VIEW)
    Columns: 11
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_enmrt_lcns_hstry_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_ENMRT_LCNS_HSTRY export.
        ...
        return """SELECT
                ...
                PRVDR_LCNS_NUM, -- TEXT(20) | NOT NULL | A NUMBER ASSIGNED BY A STATE OR TERRITORY TO AN INDIVIDUAL PROVIDER CERTIFYING THE PERSONS ABILITY TO PRACTICE MEDICINE WITHIN A RANGE OF SPECIALIZATIONS.
                PRVDR_LCNS_USPS_STATE_CD, -- TEXT(2) | NOT NULL | A CODE IDENTIFYING THE TWO-CHARACTER UNITED STATES POSTAL SERVICE (USPS) ALPHABETIC ABBREVIATION FOR THE ISSUING STATE OF THE LICENSE NUMBER. REFERENCE TABLE: GEO_USPS_STATE_CD
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_LCNS_HSTRY"""
