"""
==========
V2_PRVDR_ENMRT_NAME_HSTRY IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_NAME_HSTRY

Table Type: VIEW
Columns: 20
Source Pattern: %prvdr_enmrt%
Table Comment: A COMPILATION OF CONTACT INFORMATION USED TO LINK A NATIONAL PROVIDER IDENTIFIER (NPI) WITH THE ORGANIZATION OR INDIVIDUAL NAME OF THE ENUMERATED PROVIDER.
...
Usage:
    ...
    exporter = V2PrvdrEnmrtNameHstryExporter()
...
class V2PrvdrEnmrtNameHstryExporter(IDROutputter):
    """
    Exports V2_PRVDR_ENMRT_NAME_HSTRY data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_NAME_HSTRY (VIEW)
    Columns: 20
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_enmrt_name_hstry_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_ENMRT_NAME_HSTRY export.
