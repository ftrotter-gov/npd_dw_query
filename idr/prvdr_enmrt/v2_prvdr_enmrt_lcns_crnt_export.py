"""
==========
V2_PRVDR_ENMRT_LCNS_CRNT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_LCNS_CRNT
...
Usage:
    ...
    exporter = V2PrvdrEnmrtLcnsCrntExporter()
...
class V2PrvdrEnmrtLcnsCrntExporter(IDROutputter):
    """
    Exports V2_PRVDR_ENMRT_LCNS_CRNT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_LCNS_CRNT (VIEW)
    Columns: 8
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_enmrt_lcns_crnt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_ENMRT_LCNS_CRNT export.
        ...
        return """SELECT
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_LCNS_CRNT"""
