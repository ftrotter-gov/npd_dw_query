"""
==========
V2_PRVDR_ENMRT_SCNDRY_LANG_CRNT IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_SCNDRY_LANG_CRNT

Table Type: VIEW
Columns: 7
Source Pattern: %prvdr_enmrt%
Table Comment: AN ENUMERATED PROVIDER'S SECONDARY LANGUAGE. A PROVIDER CAN SELECT MULTIPLE SECONDARY LANGUAGES. CURRENTLY POPULATED BY THE NATIONAL PLAN AND PROVIDER ENUMERATION SYSTEM (NPPES).
...
Usage:
    ...
    exporter = V2PrvdrEnmrtScndryLangCrntExporter()
...
class V2PrvdrEnmrtScndryLangCrntExporter(IDROutputter):
    """
    Exports V2_PRVDR_ENMRT_SCNDRY_LANG_CRNT data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_SCNDRY_LANG_CRNT (VIEW)
    Columns: 7
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_enmrt_scndry_lang_crnt_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_ENMRT_SCNDRY_LANG_CRNT export.
        ...
        return """SELECT
                ...
                PRVDR_SCNDRY_LANG_TXT, -- TEXT(100) | NOT NULL | THE SECONDARY LANGUAGE OF AN ENUMERATED HEALTH CARE PROVIDER.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_SCNDRY_LANG_CRNT"""
