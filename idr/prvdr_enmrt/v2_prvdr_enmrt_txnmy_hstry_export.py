"""
==========
V2_PRVDR_ENMRT_TXNMY_HSTRY IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_TXNMY_HSTRY
...
Usage:
    ...
    exporter = V2PrvdrEnmrtTxnmyHstryExporter()
...
class V2PrvdrEnmrtTxnmyHstryExporter(IDROutputter):
    """
    Exports V2_PRVDR_ENMRT_TXNMY_HSTRY data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENMRT_TXNMY_HSTRY (VIEW)
    Columns: 11
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_enmrt_txnmy_hstry_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_ENMRT_TXNMY_HSTRY export.
