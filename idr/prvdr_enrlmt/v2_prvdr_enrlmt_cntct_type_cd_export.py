"""
==========
V2_PRVDR_ENRLMT_CNTCT_TYPE_CD IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENRLMT_CNTCT_TYPE_CD

Table Type: VIEW
Columns: 7
Source Pattern: %prvdr_enrlmt%
Table Comment: A CATEGORIZATION OF THE DIFFERENT CONTACT TYPES.
...
Usage:
    ...
    exporter = V2PrvdrEnrlmtCntctTypeCdExporter()
...
class V2PrvdrEnrlmtCntctTypeCdExporter(IDROutputter):
    """
    Exports V2_PRVDR_ENRLMT_CNTCT_TYPE_CD data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENRLMT_CNTCT_TYPE_CD (VIEW)
    Columns: 7
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_enrlmt_cntct_type_cd_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_ENRLMT_CNTCT_TYPE_CD export.
        ...
        return """SELECT
                ...
                PRVDR_ENRLMT_CNTCT_TYPE_DESC, -- TEXT(1000) | NOT NULL | A DESCRIPTION OF A TYPE OF PROVIDER CONTACT FOR AN ENROLLMENT.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENRLMT_CNTCT_TYPE_CD"""
