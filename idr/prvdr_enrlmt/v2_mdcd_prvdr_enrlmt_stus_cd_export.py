"""
==========
V2_MDCD_PRVDR_ENRLMT_STUS_CD IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCD_PRD.V2_MDCD_PRVDR_ENRLMT_STUS_CD
...
Usage:
    ...
    exporter = V2MdcdPrvdrEnrlmtStusCdExporter()
...
class V2MdcdPrvdrEnrlmtStusCdExporter(IDROutputter):
    """
    Exports V2_MDCD_PRVDR_ENRLMT_STUS_CD data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCD_PRD.V2_MDCD_PRVDR_ENRLMT_STUS_CD (VIEW)
    Columns: 10
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcd_prvdr_enrlmt_stus_cd_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCD_PRVDR_ENRLMT_STUS_CD export.
        
        Includes all 10 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                PRVDR_MDCD_ENRLMT_STUS_CD, -- TEXT(2) | NOT NULL | A CODE REPRESENTING THE STATUS OF THE PROVIDERÒ² ENROLLMENT IN THE MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP) PLAN.
                PRVDR_MDCD_ENRLMT_STUS_DESC, -- TEXT(500) | NULL | A DESCRIPTION OF THE CODE REPRESENTING THE STATUS OF THE PROVIDERÒ² ENROLLMENT IN THE MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP) PLAN.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCD_PRD.V2_MDCD_PRVDR_ENRLMT_STUS_CD"""
