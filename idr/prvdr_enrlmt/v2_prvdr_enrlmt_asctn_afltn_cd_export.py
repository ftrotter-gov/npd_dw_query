...
Table Comment: A PROVIDER'S OR SUPPLIER'S ENROLLMENT ASSOCIATION AFFILIATION CODE IN THE PROVIDER ENROLLMENT, CHAIN, AND OWNERSHIP SYSTEM (PECOS).
...
class V2PrvdrEnrlmtAsctnAfltnCdExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        """
        return """SELECT
                PRVDR_ENRLMT_ASCTN_AFLTN_CD, -- TEXT(2) | NOT NULL | A CODE INDICATING THE PROVIDER'S OR SUPPLIER'S ASSOCIATION AFFILIATION IN THE PROVIDER ENROLLMENT, CHAIN AND OWNERSHIP SYSTEM (PECOS).REFERENCE TABLE: PRVDR_PECOS_ENRLMT_ASCTN_AFLTN_CD
