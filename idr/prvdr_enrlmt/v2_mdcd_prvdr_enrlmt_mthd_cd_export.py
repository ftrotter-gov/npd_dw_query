"""
==========
V2_MDCD_PRVDR_ENRLMT_MTHD_CD IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCD_PRD.V2_MDCD_PRVDR_ENRLMT_MTHD_CD

Table Type: VIEW
Columns: 10
Source Pattern: %prvdr_enrlmt%
Table Comment: A METHOD USED TO DETERMINE THE PROVIDER ENROLLMENT.
...
Usage:
    ...
    exporter = V2MdcdPrvdrEnrlmtMthdCdExporter()
...
class V2MdcdPrvdrEnrlmtMthdCdExporter(IDROutputter):
    """
    Exports V2_MDCD_PRVDR_ENRLMT_MTHD_CD data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCD_PRD.V2_MDCD_PRVDR_ENRLMT_MTHD_CD (VIEW)
    Columns: 10
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_mdcd_prvdr_enrlmt_mthd_cd_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_MDCD_PRVDR_ENRLMT_MTHD_CD export.
        
        Includes all 10 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                PRVDR_MDCD_ENRLMT_MTHD_CD, -- TEXT(1) | NOT NULL | A CODE THAT IDENTIFIES THE SOURCE SYSTEM USED TO DESIGNATE THE PROVIDERS ENROLLMENT IN MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP).
                PRVDR_MDCD_ENRLMT_MTHD_DESC, -- TEXT(500) | NULL | A DESCRIPTION OF THE CODE THAT IDENTIFIES THE SOURCE SYSTEM USED TO DESIGNATE THE PROVIDERS ENROLLMENT IN MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP).
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCD_PRD.V2_MDCD_PRVDR_ENRLMT_MTHD_CD"""
