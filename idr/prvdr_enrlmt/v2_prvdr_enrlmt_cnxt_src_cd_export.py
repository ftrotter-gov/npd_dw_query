"""
==========
V2_PRVDR_ENRLMT_CNXT_SRC_CD IDR Export (Auto-Generated)
==========

Auto-generated IDROutputter implementation for IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENRLMT_CNXT_SRC_CD

Table Type: VIEW
Columns: 7
Source Pattern: %prvdr_enrlmt%
Table Comment: THE PROVIDER ENROLLMENT, CHAIN, AND OWNERSHIP SYSTEM (PECOS) TOPIC FROM WHICH THE RECORD IS SOURCED. 
...
Usage:
    ...
    exporter = V2PrvdrEnrlmtCnxtSrcCdExporter()
...
class V2PrvdrEnrlmtCnxtSrcCdExporter(IDROutputter):
    """
    Exports V2_PRVDR_ENRLMT_CNXT_SRC_CD data using IDROutputter base class.
    
    Auto-generated from table metadata. Customize as needed for your specific requirements.
    
    Table: IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENRLMT_CNXT_SRC_CD (VIEW)
    Columns: 7
    """
    
    # Class properties
    version_number: str = "v01"
    file_name_stub: str = "v2_prvdr_enrlmt_cnxt_src_cd_idr_export"
    
    def getSelectQuery(self) -> str:
        """
        Returns the SELECT query for V2_PRVDR_ENRLMT_CNXT_SRC_CD export.
        
        Includes all 7 columns in their original Snowflake order.
        Customize this method to add WHERE clauses, JOINs, or modify column selection.
        """
        return """SELECT
                PRVDR_ENRLMT_CNXT_SRC_CD, -- TEXT(6) | NOT NULL | A CODE INDICATING THE PROVIDER ENROLLMENT, CHAIN, AND OWNERSHIP SYSTEM (PECOS) TOPIC THE RECORD WAS RETRIEVED.
            ...
            FROM IDRC_PRD.CMS_VDM_VIEW_MDCR_PRD.V2_PRVDR_ENRLMT_CNXT_SRC_CD"""
